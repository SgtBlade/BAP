...
const Profile = () => {
  ...
  return useObserver(() => (
      <article className={style.profile}>
        <h1 className={`${style.profileName} ${style.hidden}`}>{uiStore.currentUser.surname} {uiStore.currentUser.name}</h1>
          <div className={style.profileHeader}>
            <div className={style.profileData}>
              ...
              <div className={style.profileVisual}>
                ...
                <span className={style.profileLevel}>{uiStore.currentUser.level}</span>
            ...
            <section className={style.profileTags}>
              <h2 className={style.profileTagsTitle}>Geïnteresseerd in <span className={style.profile__total}>{uiStore.currentUser.interestedTags.length}</span></h2>
              <div className={style.tags}>
                <Tag text="lorem" color={COLORS.durfGreen} margin="0 2.5rem 2.5rem 0"/>
                <Tag text="lorem" color={COLORS.durfGreen} margin="0 2.5rem 2.5rem 0"/>
                <Tag text="lorem" color={COLORS.durfGreen} margin="0 2.5rem 2.5rem 0"/>
                <Tag text="lorem" color={COLORS.durfGreen} margin="0 2.5rem 2.5rem 0"/>
                <Tag text="lorem" color={COLORS.durfGreen} margin="0 2.5rem 2.5rem 0"/>
