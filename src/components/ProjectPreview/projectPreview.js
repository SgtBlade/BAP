...
const ProjectPreview = (props, tags) => {
    ...
    return (
        <article className={style.projectCard}>
            <span className={style.borderLeft} style={{
            ...
            <div className={style.projectCard__container}>
              ...
              <div className={style.projectCard__container__content}>
                    <div className={style.projectCard__container__content__title}>
                        ...
                        <p className={style.projectCard__type} style={{
                             backgroundColor: color,
                             color: textColor
                        }}>{typeText}</p>
                    </div>
                    ...
                    <div className={style.projectCard__funding}>
                        ...
                        <p className={style.projectCard__funding__progressValues__content}>€ 1250</p>
                        <p className={style.projectCard__funding__progressValues__content}>€ 2500</p>
                        </div>
                        <progress className={style.projectCard__funding__progressBar} value="50" max="100"/>
                    ...
                    <div className={style.projectCard__voting}>
                        <p className={style.projectCard_voting_text}>Beoordeel dit project</p>
                        <p className={style.projectCard__time}>22 dagen resterend</p>
                    ...
                    {props.type === "failed" ?
                    <div className={style.projectCard__voting}>
                        <p className={style.projectCard_voting_text}>De stemmenteller staat op:</p>
                        <p className={style.projectCard__time}>22 dagen resterend</p>
                        <div className={style.projectCard__voting__container}>
                        <img src="./assets/icons/thumbs-up.svg" alt="duim omhoog"/>
                        <p className={style.projectCard__voting__amount}>40</p>
                    ...
                    <p className={style.projectCard__description}>{props.description ? props.description : ""}</p>
